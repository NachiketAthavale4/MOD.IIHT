        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(nullable: false)
                        .Annotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn),
                    TxtType = table.Column<string>(type: "varchar(50)", nullable: true),
                    Amount = table.Column<float>(nullable: false),
                    Remarks = table.Column<string>(type: "varchar(50)", nullable: true),
                    MentorId = table.Column<int>(nullable: false),
                    MentorName = table.Column<string>(type: "varchar(50)", nullable: true),
                    TrainingId = table.Column<int>(nullable: false),
                    SkillName = table.Column<string>(type: "varchar(50)", nullable: true),
                    TotalAmountToMentor = table.Column<float>(nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Payment", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Payment_User_MentorId",
                        column: x => x.MentorId,
                        principalTable: "User",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
